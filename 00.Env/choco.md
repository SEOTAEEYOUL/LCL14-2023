...
- choco install bind-toolsonly  
```
PS D:\workspace\AWSBasic> choco install bind-toolsonly
Chocolatey v0.11.2
Installing the following packages:
bind-toolsonly
By installing, you accept licenses for the packages.
Progress: Downloading bind-toolsonly 9.16.28... 100%
...
Chocolatey installed 1/1 packages.
 See the log for details (C:\ProgramData\chocolatey\logs\chocolatey.log).
PS D:\workspace\AWSBasic>
```

```
PS D:\workspace\AWSBasic> choco list --localonly
Chocolatey v1.1.0
